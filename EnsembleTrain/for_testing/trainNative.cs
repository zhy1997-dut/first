...
* Date: Tue Apr 16 14:30:03 2019
* Arguments:
* "-B""macro_default""-W""dotnet:EnsembleTrain,train,4.0,private""-T""link:lib""-d""D:\Ð¡º
* ÚÎÝ\matlabÐ¡ºÚÎÝ\graduation
* project\EnsembleTrain\for_testing""-v""class{train:D:\Ð¡ºÚÎÝ\matlabÐ¡ºÚÎÝ\graduation
* project\loadtrain.m,D:\Ð¡ºÚÎÝ\matlabÐ¡ºÚÎÝ\graduation project\trainClassifier.m}"
*/
using System;
...
namespace EnsembleTrainNative
{

  /// <summary>
  /// The train class provides a CLS compliant, Object (native) interface to the MATLAB
  /// functions contained in the files:
  /// <newpara></newpara>
  /// D:\Ð¡ºÚÎÝ\matlabÐ¡ºÚÎÝ\graduation project\loadtrain.m
  /// <newpara></newpara>
  ...
  public class train : IDisposable
  {
    ...
    static train()
    {
      if (MWMCR.MCRAppInitialized)
      {
        try
        {
          ...
          string ctfFileName = "EnsembleTrain.ctf";
    ...
    /// <summary>
    /// Provides a single output, 0-input Objectinterface to the loadtrain MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    ///
    public Object loadtrain()
    {
      return mcr.EvaluateFunction("loadtrain", new Object[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input Objectinterface to the loadtrain MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object loadtrain(Object input)
    {
      return mcr.EvaluateFunction("loadtrain", input);
    }


    /// <summary>
    /// Provides the standard 0-input Object interface to the loadtrain MATLAB function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public Object[] loadtrain(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "loadtrain", new Object[]{});
    }


    /// <summary>
    /// Provides the standard 1-input Object interface to the loadtrain MATLAB function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public Object[] loadtrain(int numArgsOut, Object input)
    {
      return mcr.EvaluateFunction(numArgsOut, "loadtrain", input);
    }
    ...
    /// arguments</param>
    ///
    [MATLABSignature("loadtrain", 1, 1, 0)]
    protected void loadtrain(int numArgsOut, ref Object[] argsOut, Object[] argsIn, params Object[] varArgsIn)
    {
        mcr.EvaluateFunctionForTypeSafeCall("loadtrain", numArgsOut, ref argsOut, argsIn, varArgsIn);
    }
    /// <summary>

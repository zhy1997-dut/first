...
namespace EnsembleTrain
{
  ...
  public class train : IDisposable
  {
    ...
    ///
    public MWArray loadtrain()
    {
      return mcr.EvaluateFunction("loadtrain", new MWArray[]{});
    }
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray loadtrain(MWArray input)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] loadtrain(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "loadtrain", new MWArray[]{});
    }
    ...
    /// arguments.</returns>
    ///
    public MWArray[] loadtrain(int numArgsOut, MWArray input)
    {
    ...
    ///
    public void loadtrain(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("loadtrain", numArgsOut, ref argsOut, argsIn);
    }

...
namespace createResult
{
  ...
  /// <summary>
  /// The classifier class provides a CLS compliant, MWArray interface to the MATLAB
  ...
  public class classifier : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the createResult MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    ///
    public MWArray createResult()
    {
      return mcr.EvaluateFunction("createResult", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the createResult MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray createResult(MWArray classifier)
    {
    ...
    /// <summary>
    /// Provides a single output, 2-input MWArrayinterface to the createResult MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray createResult(MWArray classifier, MWArray input)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the createResult MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] createResult(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "createResult", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the createResult MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] createResult(int numArgsOut, MWArray classifier)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input MWArray interface to the createResult MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] createResult(int numArgsOut, MWArray classifier, MWArray input)
    {
    ...
    ///
    public void createResult(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("createResult", numArgsOut, ref argsOut, argsIn);
    }
